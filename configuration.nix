...

{
  ...
  users.users.hiroshi = {
    ...
    openssh.authorizedKeys.keys = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOksdQLxJCCNvwD2eAeiXnAeUlwFwIheVCxXIe9DMLYL hiroshi@hiroshi-tahoe.local"
    ];
  };
  ...
  # Expose kube-apiserver (6443) only over the Tailscale interface
  # (not on the LAN or any other interface).
